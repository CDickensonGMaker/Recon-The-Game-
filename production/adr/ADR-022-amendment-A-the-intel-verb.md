...
## Build state
GAMEPLAY logic is UNBLOCKED (placement, area-circle, persistence, vocabulary, §4 probes). The pixel-glyph
RENDERING of the marks — the period bitmap look — rides with ADR-030 (HUD buffer doctrine) to final polish;
until then marks may render with placeholder chrome. Field marking is Phase 2 (with the route pencil).
