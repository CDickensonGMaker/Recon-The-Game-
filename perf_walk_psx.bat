@echo off
REM ============================================================================
REM THE PERF WALK - PSX LOOK ON. One action, run it once per state. Ship parity: the 0.75
...
set STAMP=%STAMP: =0%
"C:\Users\caleb\_tools\godot47\Godot_v4.7-stable_win64.exe" --path "%~dp0." res://scenes/levels/demo_game.tscn -- --print-fps --psx > "%~dp0perf_walk_PSX_%STAMP%.log" 2>&1
echo.
echo Walk written to perf_walk_PSX_%STAMP%.log
pause
