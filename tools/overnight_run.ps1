...
$units = @(
  @("us_grunt",      "m16a1",  "MixamoRig",     "VC1_Farmer,AK47_Rifle,VC2_MainForce,Mosin_Rifle_VC,VC5_NVA,PPSh41_Gun"),
  @("vc1_farmer",    "ak47",   "MixamoRig_VC1", "US_Grunt_Rigged,M16A1_Rifle,VC2_MainForce,Mosin_Rifle_VC,VC5_NVA,PPSh41_Gun"),
  @("vc2_mainforce", "mosin",  "RigVC2",        "US_Grunt_Rigged,M16A1_Rifle,VC1_Farmer,AK47_Rifle,VC5_NVA,PPSh41_Gun"),
  @("vc5_nva",       "ppsh41", "RigVC5",        "US_Grunt_Rigged,M16A1_Rifle,VC1_Farmer,AK47_Rifle,VC2_MainForce,Mosin_Rifle_VC")
)
foreach ($u in $units) {
  ...
  & $b -b -P "$t\assemble_sheets.py" -- $u[0] $u[1] 2>&1 |
