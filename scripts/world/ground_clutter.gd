...
## texture path, count, quad size (w,h), y_sink, jungle-only
const LAYERS := [
	["res://terrain/textures/clutter/grassland_2.png", 160, Vector2(1.4, 1.1), 0.05, false],
	["res://terrain/textures/clutter/grassland_1.png", 90, Vector2(1.0, 0.9), 0.05, false],
	["res://terrain/textures/clutter/grassland_3.png", 70, Vector2(1.2, 0.9), 0.05, false],
	["res://terrain/textures/clutter/herb_bush_picked2.png", 30, Vector2(0.9, 0.7), 0.02, true],
	["res://terrain/textures/clutter/rock.png", 22, Vector2(0.9, 0.55), 0.02, false],
	["res://terrain/textures/clutter/swamp_fallen_1.png", 10, Vector2(2.2, 1.0), 0.02, true],
	["res://terrain/textures/clutter/mushroom.png", 12, Vector2(0.4, 0.35), 0.0, true],
	["res://terrain/textures/clutter/blue_flower.png", 14, Vector2(0.35, 0.35), 0.0, false],
]
