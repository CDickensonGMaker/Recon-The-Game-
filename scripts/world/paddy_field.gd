...
## No class_name (registration-order hazard, same as hideout_rules.gd).
## The working_point NodePath is a write-only contract the activity system
## (separate PR) reads; an empty path means no behavior change today.
